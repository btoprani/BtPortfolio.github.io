...
import { BodyText, Title, themeColors } from '../components/SharedStyles';
...
const Contact = () => {
    return (
        <ContactsContainer>
            ...
            <Title>Contact</Title>
            <ContactsColumn>
                <ContactRow href='https://www.linkedin.com/in/btoprani/'>
                ...
                <ContactRow href='mailto:bhaven@toprani.quest'>
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ContactRow href='https://github.com/btoprani'>
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
