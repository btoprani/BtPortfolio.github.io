...
import { BodyText, CaseStudyType, Competitors, DemoImg, HeroSection, HeroText, LogoImage, SectionTitle, Subtitle, themeColors } from "../components/SharedStyles";
import { affinityMapBold1, affinityMapBold2, affinityMapText1, affinityMapText2, affinityMapText3, bgText, buttonBold1, buttonText1, buttonText2, conclusionText, featureSetBold1, featureSetText1, featureSetText2, hifiText1, hifiText2, lofiBold2, lofiText1, lofiText2, lofiText3, logoText, problemStatmentText, problemText, projectGoalText, researchBold1, researchText1, researchText2, solutionText, typefaceText, userFlowBold1, userFlowText1, userFlowText2 } from "../components/ZynoContent";
...
const LogosContainer = styled.div`
    margin: 40px calc((-100vw + 20px) / 6 - 20px);
    padding: 0 calc((100vw - 20px) / 6 + 20px);
    width: 100%;
    background-color: ${zynoColors.neutralBlack};
    img {
        width: 100%;
        height: auto;
    }
...
const ZynoHero = styled(HeroSection)`
    background-image: linear-gradient(to bottom right, ${zynoColors.secondary}, ${zynoColors.secondaryLight});
`;
        ...
        <HelmetProvider>
            ...
            <PageContainer>
                ...
                <PageContent>
                    ...
                    <BodyText>{affinityMapText1}<span className='boldText'>{affinityMapBold1}</span>{affinityMapText2}<span className='boldText'>{affinityMapBold2}</span>{affinityMapText3}</BodyText>
                    ...
                    <BodyText>{featureSetText1}<span className='boldText'>{featureSetBold1}</span>{featureSetText2}</BodyText>
                    <FeatureSet headerBgColor={zynoColors.primary} headerColor={zynoColors.neutralLight} caseStudyType={CaseStudyType.Zyno} />
                    <BodyText>{userFlowText1}<span className='boldText'>{userFlowBold1}</span>{userFlowText2}</BodyText>
                    ...
                    <BodyText>{lofiText2}<span className='boldText'>{lofiBold2}</span>{lofiText3}</BodyText>
                    <LofiWireframes openLightbox={openLightbox} />
                    <UserTestingCharts />
                    <br />
                    <BodyText>{buttonText1}<span className='boldText'>{buttonBold1}</span>{buttonText2}</BodyText>
                    <ButtonsContainer>
